...
{
    public class CompanyRepository : BasicRepository<Company,Guid,ChainDbContext> , ICompanyRepository
    {
        public CompanyRepository(ChainDbContext context) : base(context)
        {
        }
    }
}
